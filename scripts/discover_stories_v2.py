...
def render_page(stories, lang, config_path):
    if lang == "tr":
        title = "agrandiz hikâye keşfi v2"
        ...
        title = "agrandiz story discovery v2"
...
<body class="theme-apple profile-apple_icloud">
  <div class="shell">
    <header class="hero">
      <div class="brand">agrandiz <span>story discovery v2</span></div>
      <div class="hero-copy">
        <h1>{esc(hero)}</h1>
        <p>{esc(subtitle)}</p>
...
def write_index_links():
    ...
    insert = '''
      <a class="portal-card" href="stories-v2.tr.apple.apple_icloud.html">
        <div class="eyebrow">Türkçe · Story Discovery v2</div>
      ...
      <a class="portal-card" href="stories-v2.en.apple.apple_icloud.html">
        <div class="eyebrow">English · Story Discovery v2</div>
...
'''
    ...
    if "stories-v2.tr.apple.apple_icloud.html" in text:
        return
...
def main():
    ...
    out_json = outdir / "story_candidates_v2.json"
    ...
    for lang in langs:
        ...
        out_file = outdir / f"stories-v2.{lang}.apple.apple_icloud.html"
